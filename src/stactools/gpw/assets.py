...
ITEM_ASSETS: Dict[str, AssetDefinition] = {
    ARC30S_KEY: AssetDefinition(
        {
            "title": "30 arc-seconds, 1km",
            "description": (
    ...
    ARC2M30S_KEY: AssetDefinition(
        {
            "title": "2.5 arc-minutes, 5km",
            "description": (
    ...
    ARC15M_KEY: AssetDefinition(
        {
            "title": "15 arc-minutes, 30km",
            "description": (
    ...
    ARC30M_KEY: AssetDefinition(
        {
            "title": "30 arc-minutes, 55km",
            "description": (
    ...
    ARC60M_KEY: AssetDefinition(
        {
            "title": "60 arc-minutes, 110km",
            "description": (
